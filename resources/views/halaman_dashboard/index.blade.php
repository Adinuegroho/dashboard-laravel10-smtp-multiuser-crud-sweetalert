...
<!-- Page level plugins -->
<script src="{{ assert('halaman_dashboard/vendor/datatables/jquery.dataTables.min.js') }}"></script>
<script src="{{ assert('halaman_dashboard/vendor/datatables/dataTables.bootstrap4.min.js') }}"></script>

<!-- Page level custom scripts -->
<script src="{{ assert('halaman_dashboard/js/demo/datatables-demo.js') }}"></script>
