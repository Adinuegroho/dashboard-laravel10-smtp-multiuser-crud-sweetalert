    ...
    <div class="container-login100">
        <div class="wrap-login100">
            <form action="{{ route('registrasi') }}" class="login100-form validate-form" method="post" enctype="multipart/form-data">
                ...
                <div class="wrap-input100 validate-input" data-validate = "Valid fullname is required: xxxxx">
                ...
                <div style="margin : 20px 20px 40px 20px;">
                    <label for="gambar" style="margin-bottom: 10px; font-size: 16pt; color: #666;">Gambar</label>
                ...
                <div class="text-center p-t-46 p-b-20">
						<span class="txt2">
							Account allready?<a href="{{ route('auth') }}" class="text-primary">Login</a> or sign up using
						</span>
                </div>
